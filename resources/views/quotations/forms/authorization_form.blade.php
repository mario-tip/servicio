    ...
    <div class="row">
      <div class="col-md-12 form-group-container">
        <div class="form-group">
          ...
          <select name="quotation[authorization]" id="quotation_status_select" class="btn-group bootstrap-select bs-select form-control">
    ...
    <div class="row">
      <div class="col-md-12 form-group-container">
        <div class="form-group">
          ...
          {!! Form::textarea('quotation[comments]', null, ['size' => '30x5', 'class' => 'form-control']) !!}
        </div>
      </div>
    </div>
    <div class="row">
