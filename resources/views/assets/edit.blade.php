...
<div class="row content_container paddingForm">
  <div class="col-md-12" id="asset_form_subcontainer">
    ...
    {!! Form::model($asset, ['route' => ['actives.update', $asset->id], 'data-method' => 'PUT','files' => true]) !!}
    {!! Form::hidden('_method', 'PUT') !!} <?php // IDEA: Es necesario poner este parametro para que los archivos lleguen a la funcion update  ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  {!! Form::text('asset[asset_custom_id]', $asset->asset_custom_id, ['class' => 'form-control', 'type' => 'hidden']) !!}
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
