...
@section('breadcrumb')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="#">Historial de firmware</a>
            </li>
        </ul>
    </div>
@endsection
        ...
        <div class="col-md-12" id="asset_form_subcontainer">
            ...
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold">Historial de Firmware</span>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        <thead>
                            <tr>
                                ...
                                <th class="center">Firmware anterior</th>
                                <th class="center">Firmware actualizado</th>
