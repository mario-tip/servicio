    ...
    <div class="horizontal-form">
        <div class="form-body">
            <div class="row">
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label">Levantó incidencia: </label>
                        <label class="control-label">{{$incident->person->name}}</label>
                    </div>
                </div>
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label" for="service_order_user_id"><span>*</span>Encargado de resolución: </label>
            ...
            <div class="row">
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label">Activo: </label>
                        <label class="control-label">{{$incident->asset->name}}</label>
                    </div>
                </div>
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label">Marca: </label>
            ...
            <div class="row">
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label">Id de activo: </label>
                        <label class="control-label">{{$incident->asset->asset_custom_id}}</label>
                    </div>
                </div>
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label">Ubicación: </label>
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label textarea-label">Partes afectadas: </label>
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label textarea-label">Descripción del problema: </label>
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group-container">
                    <div class="form-group datepicker-group">
                        <label class="control-label form-label" for="service_order_date"><span>*</span>Fecha: </label>
                ...
                <div class="col-md-6 form-group-container">
                    <div class="form-group timepicker-group">
                        <label class="control-label form-label" for="service_order_time"><span>*</span>Hora: </label>
            ...
            <div class="row">
                <div class="col-md-11 form-group-container">
                    <div class="form-group">
                        <label class="control-label form-label textarea-label" for="service_order_notes"><span></span>Notas: </label>
