        ...
        <div class="horizontal-form">
          <div class="form-body bodyForm">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="" for="username"><span class="required" aria-required="true">* </span>User: </label>
                                ...
                                <div class="icheck-list">
                                  ...
                                  <label>
                                    <div class="icheckbox_flat-grey " style="position: relative;">
                                      ...
                                      <input type="checkbox" name="notifications[]" value="{{$user->id}}" {{in_array($user->id ,old('notifications',[])) ? 'checked' : '' }} {{$user->active ? 'checked' : '' }} class="icheck" data-checkbox="icheckbox_flat-grey"
                                ...
                                <div class="icheck-list">
                                  ...
                                  <label>
                                    <div class="icheckbox_flat-grey " style="position: relative;">
                                      ...
                                      <input type="checkbox" name="notifications_order[]" value="{{$user->id}}" {{in_array($user->id ,old('notifications_order',[])) ? 'checked' : '' }} {{$user->active_order ? 'checked' : '' }} class="icheck"
                                        data-checkbox="icheckbox_flat-grey" style="position: absolute; opacity: 0;">
                                ...
                                <div class="icheck-list">
                                  ...
                                  <label>
                                    <div class="icheckbox_flat-grey " style="position: relative;">
                                      ...
                                      <input type="checkbox" name="notifications_end[]" value="{{$user->id}}" {{in_array($user->id ,old('notifications_end',[])) ? 'checked' : '' }} {{$user->active_end ? 'checked' : '' }} class="icheck" data-checkbox="icheckbox_flat-grey"
                                        style="position: absolute; opacity: 0;">
