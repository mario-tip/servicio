...
class Incident extends Model
{
    ...
    protected $fillable = [
      'folio','type','description','suggested_date','suggested_time','priority',
      'evidence_file','notes','asset_id','person_id','user_id',
    ];
    ...
    public function parts(){
        return $this->belongsToMany(Part::class, 'incident_part', 'incident_id', 'part_id');
    }
